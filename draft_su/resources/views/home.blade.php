                                ...
                                <div class="carousel-inner">
                                  <div class="carousel-item active" data-bs-interval="10000">
                                    ...
                                    <div class="carousel-caption d-none d-md-block">
                                      <h5 style="color: #fff;">Solid Bulks Cargos</h5>
                                      <p  style="color: #fff;"> 35,000 tons are loaded per vessel.</p>
                                    </div>
                                  </div>
                                  <div class="carousel-item">
                                    <img src="{{ asset('img/fondo.jpg') }}" class="d-block w-100 h-100" alt="...">
                                    <div class="carousel-caption d-none d-md-block">
                                      <h5 style="color: #fff;">Certified Cargo Inspectors</h5>
                                      <p style="color: #fff;">All cargo inspectors have an IFIA certification.</p>
                                    </div>
                                  </div>
                                </div>
